function AddEclipseAtomicArray(rad, X0, Y0, VX0, VY0, InitDist, Temp, Type)
global C
...
L = (2*rad ) * AtomSpacing; %REMOVED THE (-1)on both the Length and Width 
W = (2*rad ) * AtomSpacing; %to get the code for an Eclipse
